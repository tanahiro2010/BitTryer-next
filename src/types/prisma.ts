...
export type CreateUser = Omit<BaseUser, 'id' | 'client_id' | 'slug' | 'createdAt' | 'updatedAt'>
export type CreateCoin = Omit<BaseCoin, 'id' | 'coin_id' | 'createdAt' | 'updatedAt'>
export type CreatePortfolio = Omit<BasePortfolio, 'id' | 'createdAt' | 'updatedAt'>
export type CreateTradeHistory = Omit<BaseTradeHistory, 'id' | 'history_id' | 'createdAt' | 'updatedAt'>

// Update types (更新可能フィールドのみ)
export type UpdateUser = Partial<Pick<BaseUser, 'name' | 'slug' | 'base_coin'>>
export type UpdateCoin = Partial<Pick<BaseCoin, 'description' | 'current_price' | 'high_24h' | 'low_24h' | 'volume_24h' | 'change_24h' | 'change_24h_percent' | 'market_cap' | 'rank' | 'is_active' | 'is_tradeable'>>
