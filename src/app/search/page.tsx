        ...
        <div className="container mx-auto px-4 py-8 max-w-6xl">
            ...
            <div className="mb-8">
                ...
                <div className="flex items-center justify-between">
                    <p className="text-gray-600">
                        <span className="font-semibold text-blue-600">{users.length}</span> 件のユーザーが見つかりました
                    </p>
                </div>
            </div>
            ...
            {users.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {users.map(user => (
                        <Card key={user.userId} className="hover:shadow-lg transition-shadow duration-200 border-l-4 border-l-blue-500">
                            ...
                            <CardContent className="pt-0">
                                <div className="space-y-3">
                                    <div className="flex items-center gap-2 text-sm text-gray-600">
                                        ...
                                        <span>
                                            登録日: {new Date(user.user.createdAt).toLocaleDateString('ja-JP')}
                                        </span>
                                    </div>
